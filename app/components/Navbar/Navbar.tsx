...
const Navbar = () => {
  ...
  // Toggle dropdown visibility for Sign In button
  const toggleSignInDropdown = () => {
    setIsSignInOpen(!isSignInOpen);
    setIsRegisterOpen(false); // Close register dropdown if open
  };

  // Toggle dropdown visibility for Register button
  const toggleRegisterDropdown = () => {
    setIsRegisterOpen(!isRegisterOpen);
    setIsSignInOpen(false); // Close sign-in dropdown if open
  };
      ...
      <>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative flex h-20 items-center justify-between">
            ...
            {/* SIGNIN BUTTON WITH DROPDOWN */}
            <div className="relative mr-4"> {/* Added margin-right for spacing */}
              <button
