    ...
    return (
            <div id="mentors-section" className="mx-auto max-w-2xl pb-16 px-4 sm:py-20 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className='sm:flex justify-between items-center mb-12'>
                    ...
                    <div>
                        <button className="bg-transparent hover:bg-purple-700  text-purple font-medium hover:text-white py-3 px-4 border border-lightgrey hover:border-transparent rounded">
