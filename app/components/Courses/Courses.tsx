        ...
        <div>
            <div id='courses-section' className="mx-auto max-w-2xl py-16 px-4 sm:py-36 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className='sm:flex justify-between items-center pb-12'>
                    ...
                    <div>
                        <button className="bg-transparent hover:bg-purple-700  text-purple font-medium hover:text-white py-3 px-4 border border-purple hover:border-transparent rounded">
                            Explore Classes
                        </button>
                    </div>
                </div>
